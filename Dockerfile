...
ARG RESTY_EVAL_POST_MAKE="adduser -D -H -h /dev/null -s /sbin/nologin www-data"
...
RUN apk add --no-cache --virtual .build-deps \
    ...
    && curl -fSL https://github.com/FRiCKLE/ngx_cache_purge/archive/2.3.tar.gz -o ngx_cache_purge-2.3.tar.gz \
    ...
    && rm -rf \
        ...
        ngx_cache_purge-2.3.tar.gz ngx_cache_purge-2.3 ngx_brotli \
    && apk del .build-deps \
